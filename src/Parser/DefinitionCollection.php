...
//        foreach ($definition->deriving() as $deriving) {
...
//        }
        ...
        $this->constructorDefinitions[$definition->constructor()->name()] = $definition;


//        foreach ($definition->constructor() as $key => $constructor) {
//        }
    }
